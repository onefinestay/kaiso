...
Any client specific Relationship class must inherit from Relationship to be
usable within the framework.
...
to the data store.
They may be used by client code for querying and map to pyhton's
issubclass() and isinstanceof() functionality.
"""
